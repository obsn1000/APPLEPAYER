    ...
    <>
      ...
      <div className="container">
        ...
        <div className="input-section">
          <h2>Enter Pass from Reapware</h2>
          <div className="input-container">
            <input 
              type="text" 
              id="reapware-pass-input" 
              placeholder="Paste your pass/code from reapware here..."
              className="pass-input"
            />
            <button id="process-pass-button" className="button" aria-label="Process reapware pass">
              <span aria-hidden="true">⚡</span> Process Pass
            </button>
          </div>
        </div>
            ...
            document.getElementById('process-pass-button').addEventListener('click', async () => {
              try {
                ...
                if (validationData.valid) {
                  ...
                  showResult(\`<h3>✅ Valid Reapware Pass</h3><p><strong>Pass:</strong> \${passValue}</p><p><strong>Status:</strong> Valid and ready to use</p>\`, 'success');
                  ...
                  showResult(\`<h3>❌ Invalid Pass</h3><p>The pass you entered is not valid or has expired.</p>\`, 'error');
                }
